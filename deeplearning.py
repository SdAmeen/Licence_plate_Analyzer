...
# Load YOLO model
net = cv2.dnn.readNetFromONNX('Load Your  Model')
...
def test_model(image_path):
    ...
    cv2.imwrite('./static/predict/test_result.jpg', result_img)
    plt.imshow(cv2.cvtColor(result_img, cv2.COLOR_BGR2RGB))
    plt.axis('off')
    plt.show()
    print("Recognized text:", text_list)

if __name__ == "__main__":
    test_image_path = '' # If you want to test the trained model upload your image path
